  ...
  return (
    ...
    <Navbar/>
      <div class="row">
        ...
        <div class="main-section col-sm min-vh-100 pe-0">
          {/* <!-- content --> */}
          <div class="content d-flex justify-content-between">
            <div class="main-content w-100 p-4 mt-2">
              <div class="content-header d-flex justify-content-between">
                <div class="content-header d-flex justify-content-between align-items-center">
                  ...
                  <p class="main-content-header mb-0">Shared with me</p>
                </div>
              ...
              <div class="filor"></div>
              <div class="doc-box doc-shared mb-3 me-3">
                <div class="doc-title ps-3">
                  <div>
                    <img class="img-fluid" src={preview} alt="" />
                  </div>
                  <span>
                    <img class="me-1" src={png} alt="" />
                    Screenshot1.png
                  </span>
                </div>
                <div class="doc-action d-flex justify-content-between">
                  <a class="doc-action-link py-2" href="">
                    <img src={eye} alt="" />
                  </a>
                  <a class="doc-action-link py-2" href="">
                    <img src={doc} alt="" />
            ...
            <div className="main-content w-100 p-4 mt-2">
              <div className="content-header d-flex justify-content-between">
                <div className="content-header d-flex justify-content-between align-items-center">
                  ...
                  <p className="main-content-header mb-0">Shared with me</p>
                </div>
              ...
              <div className="filor"></div>
              <div className="doc-box doc-shared mb-3 me-3">
                <div className="doc-title ps-3">
                  <div>
