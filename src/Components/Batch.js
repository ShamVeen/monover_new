          ...
          <div className="content d-flex justify-content-between">
            <div className="main-content p-4 mt-2">
              ...
              <div className="content-wrapper mt-5">
                <div className="batch-wrapper d-flex -justify-content-between flex-wrap">
                  <div className="batch-item me-4 mb-4 d-flex flex-column justify-content-between">
                    <div className="h-100 px-3 d-flex align-items-center">
                      <div className="batch-content">
                        <h5 className="batch-title mb-0">My Supering Batch</h5>
                        <span className="batch-subtitle">5 files</span>
                      </div>
                    </div>
                    <div className="batch-footer border-top-grey py-2 px-3">
                      <span>500MB</span>
                    </div>
                  </div>
                  <div className="batch-item me-4 mb-4 d-flex flex-column justify-content-between">
                    <div className="h-100 px-3 d-flex align-items-center">
                      <div className="batch-content">
                        <h5 className="batch-title mb-0">My Super Batch</h5>
                        <span className="batch-subtitle">5 files</span>
                      </div>
                    </div>
                    <div className="batch-footer border-top-grey py-2 px-3">
                  ...
                  <div className="batch-item add-batch-item d-flex flex-column justify-content-center align-items-center">
                    <div className="text-center">
                      ...
                      >
                        <path
                          d="M6.29025 16.016V9.328H0.0502501V7.152H6.29025V0.463999H8.72225V7.152H14.9623V9.328H8.72225V16.016H6.29025Z"
                          fill="#C3CAD9"
                        />
                      </svg>
                      <h5 className="batch-title mt-2">New Batch</h5>
                    </div>
                  </div>
                </div>
              </div>
