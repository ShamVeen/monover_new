            ...
            <div className="main-content w-100 p-4 mt-2">
              <div className="content-header d-flex justify-content-between">
                <div className="content-header d-flex justify-content-between align-items-center">
                  ...
                  <p className="main-content-header mb-0">Process</p>
                </div>
              ...
              <div className="content-wrapper mt-5">
                <div className="edit-process-wrapper d-flex -justify-content-between flex-wrap">
                  <h2 className="fs-16 fw-bold">Purchase</h2>

                  <table className="table mt-4 border-top-grey">
                    <tbody>
                      <tr>
                        <td className="ps-3" valign="middle">
                          Step 1
                        </td>
                        <td className="ps-5" valign="middle">
                          <span className="fw-bold fs-14 pe-3">
                            Purchase Order
                          </span>
                        ...
                        <td>
                          <div className="d-flex align-items-center">
                            <div className="me-5">
                              ...
                              <span className="color-grey ps-3">
                                Sales Manager
                              </span>
                            </div>
                            <a className="fs-16 edit-link" href="">
