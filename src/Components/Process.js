        ...
        <div className="content d-flex justify-content-between">
          <div className="main-content w-100 p-4 mt-2">
            ...
            <div className="content-wrapper mt-5">
              <div className="process-wrapper d-flex -justify-content-between flex-wrap">
                <table className="table">
                  <thead>
                    <tr bgcolor="#F1F4F9">
                      <th className="ps-3 border-right-grey" width="30%">
                        Process Name
                      </th>
                      <th className="ps-5">Members</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="ps-3 border-right-grey">Purchase</td>
                      <td className="ps-5">5 Participants</td>
                      <td>
                        <a href="">
                          <svg
                            width="10"
